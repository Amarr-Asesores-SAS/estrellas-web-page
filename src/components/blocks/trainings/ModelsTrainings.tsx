...
const items: ITrainingItem[] = [
	...
	{
		title: 'Vocabulario básico en la',
...
const ModelsTrainings = () => {
	return <TrainingsCollectionCards items={items} />
}

export default ModelsTrainings
